...
function(apply_cargokit target manifest_dir lib_name any_symbol_name)
    ...
    elseif(CMAKE_SYSTEM_NAME STREQUAL "Linux")
        set(CARGOKIT_TARGET_PLATFORM "linux-x64")
    elseif(CMAKE_SYSTEM_NAME STREQUAL "Darwin")
        if(CMAKE_SYSTEM_PROCESSOR STREQUAL "arm64")
            set(CARGOKIT_TARGET_PLATFORM "macos-arm64")
        else()
            set(CARGOKIT_TARGET_PLATFORM "macos-x64")
        endif()
    else()
        message(FATAL_ERROR "Unsupported platform: ${CMAKE_SYSTEM_NAME}. Set FLUTTER_TARGET_PLATFORM manually.")
    endif()
